  ...
  return (
    <div>
      ...
      <section className="py-8 px-4 bg-lightblue about md:py-12">
        <article className="container mx-auto">
          ...
          <div className="flex flex-col gap-4 font-alternate md:text-xl">
            <Fade left><p>03 Finance School was birthed as a result of the harm that lack of financial Information has caused many individuals and countries in Africa.</p></Fade>
            <Fade left><p>The Initiative’s goal is to promote financial education in the areas of Wealth Creation, Wealth Sustainability, and Wealth Management.</p></Fade>
            <Fade left><p>We intend to organize seminars, workshops, webinars, online training, conferences, and charity events to boost financial education across Nigeria and Africa. We will conduct digital skills training and provide financial education for survival in the 21st century.</p></Fade>
            <Fade left><p>Our focus is to create impactful programs that will make a pathway for youths to take appropriate actions for the development of themselves, and global village.</p></Fade>
          </div>
        </article>
      </section>
      </Fade>
      ...
      <section className="py-8 px-4 bg-white">
        ...
        <Fade bottom><p className="text-[#DBFFCD] text-lg benzin-medium md:text-2xl">Want to become a student?</p></Fade>
        <Fade bottom><h3 className="text-darkblue text-lg benzin-medium md:text-2xl">JOIN OUR COMMMUNITIES</h3></Fade>
        <Fade bottom><p className="text-white font-alternate text-base md:text-xl md:my-6">Become a student and join other finance and blockchain enthusiast in our community. Share and gain ideas from different brains</p></Fade>
