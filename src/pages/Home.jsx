    ...
    <div>
      ...
      <main className='hero '>
        ...
        <section className='flex flex-col gap-6 px-4 py-8 md:px-0 md:pb-12 md:flex-row-reverse md:justify-center md:items-center'>
          ...
          <article className="text-center text-white md:text-left md:flex-[60%]">
            <h3 className="text-lg font-bold mb-2 md:text-[40px]">We teach you about finance</h3>
            <p className="md:text-3xl">Financial information to achieve wealth creation, wealth sustainability, and wealth management</p>
          </article>
        </section>
        </div>
      </main>
      ...
      <section className="py-8 px-4 bg-white">
        <article className="text-center bg-lightgreen p-4 md:w-1/2 md:mx-auto">
          <p className="text-[#DBFFCD] text-lg md:text-3xl">Want to become a student?</p>
          <h3 className="text-darkblue text-lg font-bold">JOIN OUR COMMMUNITIES</h3>
          <p className="text-white font-alternate text-base md:text-xl md:my-8">Become a student and join other finance and blockchain enthusiast in our community. Share and gain ideas from different brains</p>
      ...
      <section className="bg-mobile-update-bg bg-no-repeat bg-cover text-white py-12 px-4 text-center font-alternate md:bg-desktop-update-bg">
        <article  className="container mx-auto flex flex-col gap-4 md:w-1/2 md:mx-auto md:py-6">
          <h2 className="text-xl font-bold md:text-3xl">DONT WANT TO MISS OUT ON UPDATES?</h2>
